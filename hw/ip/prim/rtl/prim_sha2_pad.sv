...
#(
  ...
  // TODO: tie off message_length_i[127:64] for !MultimodeEn, fifo_rdata.data and mask extra bits
  // shaf_rdata extra bits, digest_mode, message_length_i extra bits, tx_count extra bits
