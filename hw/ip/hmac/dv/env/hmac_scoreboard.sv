      ...
      if ((item.a_addr & addr_mask) inside {[HMAC_MSG_FIFO_BASE : HMAC_MSG_FIFO_LAST_ADDR]}) begin
        ...
        if (do_predict) begin
          ...
          if (csr_name.substr(0, 5) == "digest") begin
            ...
            if ((item.a_data[7:4] != SHA2_256) &&
                (item.a_data[7:4] != SHA2_384) &&
                (item.a_data[7:4] != SHA2_512)) begin
            ...
            if ((item.a_data[13:8] != Key_128) &&
                (item.a_data[13:8] != Key_256) &&
                (item.a_data[13:8] != Key_384) &&
                (item.a_data[13:8] != Key_512) &&
                (item.a_data[13:8] != Key_1024)) begin
        ...
        forever begin
          ...
          fork
            begin : key_padding
              ...
              if (ral.cfg.hmac_en.get_mirrored_value() && hmac_rd_cnt == 0 && invalid_cfg == 0) begin
